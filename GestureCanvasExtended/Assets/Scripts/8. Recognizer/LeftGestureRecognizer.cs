...
public class LeftGestureRecognizer : MonoBehaviour
{
    ...
    public void Initialize(Interaction i)
    {
        ...
        ds = GestureDataset.GestureDataset_L;
        ...
        expectedId = Target.expectedGestureId_L;
    ...
    private IEnumerator ShowMessage(float waitTime)
    {
        ...
        LeftHandVisual.GetComponent<HighlightPlus.HighlightEffect>().highlighted = true;
        yield return new WaitForSeconds(waitTime);
        LeftHandVisual.GetComponent<HighlightPlus.HighlightEffect>().highlighted = false;
    ...
    private void LateUpdate()
    {
        ...
        if (active == true && gestureRecognizer.trained_L == true)
        {
